...
**Q4. What are the properties of air?** 
    ...
    * **Answer:**
    ...
    3. It has no colour (colourless).
    4. It has no smell, i.e., it is odourless.
...
**Q13. Mention the causes of air pollution.** 
    ...
    **Human activities causing air pollution:**
    1. **Emissions from industries and manufacturing activities** – Waste incinerators and manufacturing industries emit high levels of carbon monoxide and organic compounds into the air, causing air pollution.
    2. **Burning of fossil fuels** – Cars, heavy-duty trucks, trains, and aeroplanes burn a lot of fossil fuel to work. Emissions from these engines produce both primary and secondary pollution. Since we rely heavily on vehicles for transportation, this is very difficult to manage.
    3. **Fertilizers and pesticides** – Fertilizers and pesticides used in fields, fumigating homes, paints used at home, and gases used for pest control release harmful gases into the air.
    4. **Widespread stubble burning** – Widespread stubble burning or forest fires release a lot of harmful gases into the air.
    5. **Spread of viruses** – Viruses spread in the air through spitting or sneezing, which causes infectious diseases.

**Q14. What are the causes of air pollution? (Second version)**

    * **Answer:**
    The various causes of air pollution are as follows:
    1. Burning of fossil fuels for vehicles, machineries, and cooking.
    2. Emissions from industries and other manufacturing activities.
...
**Q18. How can we check and prevent air pollution?** 
    ...
    * **Answer:**
    ...
    1. Governments across the world have invested in green/renewable sources of energy in order to minimize the burning of fossil fuels.
...
**Q19. What can we, as a community or as individuals, do to prevent air pollution?** 
    ...
    * **Answer:**
    ...
    4. Avoid burning garbage frequently.
    5. We can make use of renewable sources of energy at home, like solar panels, electric cookers, etc.
    6. We should plant trees.
    7. We should not use plastic bags.

## 8. Quick Recap — Fill in the Blanks

1. Any **fire** requires heat, fuel, and oxygen.
2. When we breathe in, the **diaphragm** expands and fresh air is pulled into our lungs through the nose.
3. **Breathing** is a two-step process involving breathing-in and breathing-out.
4. Air is an **odourless**, **colourless** mixture of many gases, water vapour, and dust particles.
5. **Air** expands on heating and contracts on cooling.

## 9. Quick Recap — True or False

1. Air is a mixture of two gases. → **False**
2. Air does not have weight. → **False**
3. When we breathe out, carbon dioxide is passed out of our lungs. → **True**
4. Oxygen is essential for burning. → **True**
5. Carbon monoxide gas is an air pollutant. → **True**

## 10. Quick Recap — Name the Following

1. Supports burning → **Oxygen**
2. Requirements for fire → **Heat, oxygen, and fuel**
3. Two examples of pollutants → **Carbon monoxide, hydrocarbons**
4. Percentage of oxygen in air → **21%**
5. Percentage of nitrogen in air → **78%**
6. Gas required for the process of photosynthesis → **Carbon dioxide**
7. The blanket of air surrounding the Earth → **Atmosphere**
8. The gas we breathe out → **Carbon dioxide**
9. The major part of air → **Nitrogen**
10. Air pollution is caused by → **Emissions from industries**
11. Air has → **An indefinite shape**
